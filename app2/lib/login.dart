        ...
        child: Container(
          child: BlocConsumer<FilterCubit, FilterState>(
            ...
            builder: (context, login) {
              ...
              } else if (login.status == LoginStatus.signInInProgress) {
                return Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
              ...
              } else if (login.status == LoginStatus.subscriptionInProgress) {
                return Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
              ...
              } else if (login.status == LoginStatus.phoneVerifying) {
                return Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
