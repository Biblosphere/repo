...
class MainPageOld extends StatefulWidget {
  MainPageOld(List<CameraDescription> cameras, {Key key}) : super(key: key);

  @override
  _MainPageState createState() => _MainPageState(cameras);
}

class _MainPageState extends State<MainPageOld>
  ...
  void didChangeDependencies() {
    ...
    context.cubit<FilterCubitOld>().setSnappingController(_controller);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: CubitBuilder<FilterCubitOld, FilterState>(builder: (context, filters) {
            ...
            SnappingSheet(
              ...
              onSnapEnd: () {
                if (_snapPosition < 10.0)
                  context.cubit<FilterCubitOld>().panelHiden();
                else if (_snapPosition < 100.0)
                  context.cubit<FilterCubitOld>().panelMinimized();
                else if (_snapPosition < 240.0)
                  context.cubit<FilterCubitOld>().panelOpened();
                ...
                child: TripleButton(
                  ...
                  onPressed: [
                    ...
                    () {
                      ...
                      context.cubit<FilterCubitOld>().setView(ViewType.map);
                    },
                    ...
                    () {
                      ...
                      context.cubit<FilterCubitOld>().setView(ViewType.camera);
                    },
                    //onPressed for LIST
                    () {
                      // TODO: remember a position and restore it
                      ...
                      context.cubit<FilterCubitOld>().setView(ViewType.list);
                    }
                  ],
                  onPressedSelected: [
                  ...
                  onLongPress: [
                    //onLongPress for MAP
                    () {
                      context.cubit<FilterCubitOld>().mapButtonLongPress();
                    },
