...
class Shelf {
  ...
  static Future<Shelf> fromBook(Book book) async {
    ...
    PhotoModel photo = PhotoModel.fromJson(doc.id, doc.data());
  ...
  static Future<Shelf> fromPhoto(PhotoModel photo) async {
    // Read books
    List<Book> books = await getBooks(photo);
  ...
  static Future<List<Book>> getBooks(PhotoModel photo) async {
